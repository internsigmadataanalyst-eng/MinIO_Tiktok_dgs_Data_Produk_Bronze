# src/data_produk/ingestion/fetch_data_produk_gsheet.py
import os
...
def fetch_tiktok_data_produk(gc: gspread.Client) -> pd.DataFrame:
    """
    ...
    tiktok_produk = pd.concat(frames, ignore_index=True)
    return tiktok_produk
